 ...
 * Copyright(c) 2015 xbolshe <pub@relvarsoft.com>
 *
...
static struct dw_dma_slave dma_dws[][2] = {
	[INTEL_QUARK_UART1] = {
		[RX] = {
			.src_id = INTEL_QUARK_UART1_RX_CH_ID,
		},
		[TX] = {
			.dst_id = INTEL_QUARK_UART1_TX_CH_ID,
		},
	},
	[INTEL_QUARK_UART2] = {
		[RX] = {
			.src_id = INTEL_QUARK_UART2_RX_CH_ID,
		},
		[TX] = {
			.dst_id = INTEL_QUARK_UART2_TX_CH_ID,
		},
	},
};
...
static struct plat_serial8250_port serial8250_pdata[] = {
	[INTEL_QUARK_UART1] = {
		.mapbase = 	INTEL_X1000_DMA_MAPBASE,
		.uartclk = 44236800,
		.iotype = UPIO_MEM32,
		.regshift = 2,
